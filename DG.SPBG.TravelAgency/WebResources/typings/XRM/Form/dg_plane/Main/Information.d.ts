...
declare module Form.dg_plane.Main {
  module Information {
    module Tabs {
    }
    interface Attributes extends IPage.AttributeCollectionBase {
      get(name: "dg_name"): IPage.Attribute<string>;
      get(name: "dg_outbound"): IPage.Attribute<Date>;
      get(name: "dg_return"): IPage.Attribute<Date>;
    ...
    interface Controls extends IPage.ControlCollectionBase {
      ...
      get(name: "dg_outbound"): IPage.DateControl;
      get(name: "dg_return"): IPage.DateControl;
  ...
  interface Information extends IPage.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "dg_outbound"): IPage.Attribute<Date>;
    getAttribute(attributeName: "dg_return"): IPage.Attribute<Date>;
    ...
    getControl(controlName: "dg_outbound"): IPage.DateControl;
    getControl(controlName: "dg_return"): IPage.DateControl;
