...
declare module Form.dg_plane.Card {
  module Information {
    module Tabs {
    ...
    interface Attributes extends IPage.AttributeCollectionBase {
      get(name: "statuscode"): IPage.OptionSetAttribute<dg_plane_statuscode>;
    ...
    interface Controls extends IPage.ControlCollectionBase {
      get(name: "statuscode"): IPage.OptionSetControl<dg_plane_statuscode>;
  ...
  interface Information extends IPage.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    getAttribute(attributeName: "statuscode"): IPage.OptionSetAttribute<dg_plane_statuscode>;
    ...
    getControl(controlName: "statuscode"): IPage.OptionSetControl<dg_plane_statuscode>;
