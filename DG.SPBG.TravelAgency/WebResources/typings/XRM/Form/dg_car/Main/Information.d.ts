...
declare module Form.dg_car.Main {
  module Information {
    module Tabs {
    }
    interface Attributes extends IPage.AttributeCollectionBase {
      get(name: "dg_name"): IPage.Attribute<string>;
      get(name: "dg_rentfrom"): IPage.Attribute<Date>;
      get(name: "dg_rentto"): IPage.Attribute<Date>;
    ...
    interface Controls extends IPage.ControlCollectionBase {
      ...
      get(name: "dg_rentfrom"): IPage.DateControl;
      get(name: "dg_rentto"): IPage.DateControl;
  ...
  interface Information extends IPage.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "dg_rentfrom"): IPage.Attribute<Date>;
    getAttribute(attributeName: "dg_rentto"): IPage.Attribute<Date>;
    ...
    getControl(controlName: "dg_rentfrom"): IPage.DateControl;
    getControl(controlName: "dg_rentto"): IPage.DateControl;
