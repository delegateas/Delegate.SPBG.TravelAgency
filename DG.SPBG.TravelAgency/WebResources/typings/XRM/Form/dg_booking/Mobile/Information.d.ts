...
declare module Form.dg_booking.Mobile {
  module Information {
    module Tabs {
    ...
    interface Attributes extends IPage.AttributeCollectionBase {
      ...
      get(name: "statecode"): IPage.OptionSetAttribute<dg_booking_statecode>;
    ...
    interface Controls extends IPage.ControlCollectionBase {
      ...
      get(name: "statecode"): IPage.OptionSetControl<dg_booking_statecode>;
  ...
  interface Information extends IPage.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "statecode"): IPage.OptionSetAttribute<dg_booking_statecode>;
    ...
    getControl(controlName: "statecode"): IPage.OptionSetControl<dg_booking_statecode>;
