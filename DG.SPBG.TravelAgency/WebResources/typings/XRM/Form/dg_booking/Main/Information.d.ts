...
declare module Form.dg_booking.Main {
  module Information {
    module Tabs {
    }
    interface Attributes extends IPage.AttributeCollectionBase {
      get(name: "dg_name"): IPage.Attribute<string>;
      get(name: "dg_plane"): IPage.LookupAttribute;
      get(name: "dg_hotel"): IPage.LookupAttribute;
      get(name: "dg_car"): IPage.LookupAttribute;
    ...
    interface Controls extends IPage.ControlCollectionBase {
      ...
      get(name: "dg_plane"): IPage.LookupControl;
      get(name: "dg_hotel"): IPage.LookupControl;
      get(name: "dg_car"): IPage.LookupControl;
  ...
  interface Information extends IPage.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "dg_plane"): IPage.LookupAttribute;
    getAttribute(attributeName: "dg_hotel"): IPage.LookupAttribute;
    getAttribute(attributeName: "dg_car"): IPage.LookupAttribute;
    ...
    getControl(controlName: "dg_plane"): IPage.LookupControl;
    getControl(controlName: "dg_hotel"): IPage.LookupControl;
    getControl(controlName: "dg_car"): IPage.LookupControl;
