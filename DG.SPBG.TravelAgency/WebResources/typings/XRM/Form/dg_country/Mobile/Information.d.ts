...
declare module Form.dg_country.Mobile {
  module Information {
    module Tabs {
    ...
    interface Attributes extends IPage.AttributeCollectionBase {
      ...
      get(name: "statecode"): IPage.OptionSetAttribute<dg_country_statecode>;
    ...
    interface Controls extends IPage.ControlCollectionBase {
      ...
      get(name: "statecode"): IPage.OptionSetControl<dg_country_statecode>;
  ...
  interface Information extends IPage.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "statecode"): IPage.OptionSetAttribute<dg_country_statecode>;
    getAttribute(attributeName: string): IPage.EmptyAttribute;
    getControl(controlName: "dg_name"): IPage.StringControl;
    getControl(controlName: "statecode"): IPage.OptionSetControl<dg_country_statecode>;
