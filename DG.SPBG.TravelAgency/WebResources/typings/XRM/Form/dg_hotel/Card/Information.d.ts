...
declare module Form.dg_hotel.Card {
  module Information {
    module Tabs {
    ...
    interface Attributes extends IPage.AttributeCollectionBase {
      get(name: "statuscode"): IPage.OptionSetAttribute<dg_hotel_statuscode>;
    ...
    interface Controls extends IPage.ControlCollectionBase {
      get(name: "statuscode"): IPage.OptionSetControl<dg_hotel_statuscode>;
  ...
  interface Information extends IPage.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    getAttribute(attributeName: "statuscode"): IPage.OptionSetAttribute<dg_hotel_statuscode>;
    ...
    getControl(controlName: "statuscode"): IPage.OptionSetControl<dg_hotel_statuscode>;
